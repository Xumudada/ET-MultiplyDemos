...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_Component_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            if (genericMethods.TryGetValue("GetParent", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.GetParameters().Length == 0)
                    {
                        ...
                        app.RegisterCLRMethodRedirection(method, GetParent_1);
        ...
        static StackObject* GetParent_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ...
            var result_of_this_method = instance_of_this_method.GetParent<ETModel.Gamer>();
