...
{
    unsafe class System_Collections_Generic_Dictionary_2_Int32_Gamer_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.Dictionary<System.Int32, ETModel.Gamer>);
            args = new Type[]{typeof(System.Int32), typeof(ETModel.Gamer)};
            ...
            args = new Type[]{typeof(System.Int32), typeof(ETModel.Gamer).MakeByRefType()};
        ...
        static StackObject* Add_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETModel.Gamer @value = (ETModel.Gamer)typeof(ETModel.Gamer).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            ...
            System.Collections.Generic.Dictionary<System.Int32, ETModel.Gamer> instance_of_this_method = (System.Collections.Generic.Dictionary<System.Int32, ETModel.Gamer>)typeof(System.Collections.Generic.Dictionary<System.Int32, ETModel.Gamer>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* TryGetValue_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            ETModel.Gamer @value = (ETModel.Gamer)typeof(ETModel.Gamer).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack));
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as ETModel.Gamer[];
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.Dictionary<System.Int32, ETModel.Gamer>();
