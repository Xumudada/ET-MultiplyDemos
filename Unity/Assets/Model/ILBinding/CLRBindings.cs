...
namespace ILRuntime.Runtime.Generated
{
    class CLRBindings
    {
        ...
        public static void Initialize(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            ETModel_Gamer_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_Int32_Gamer_Binding.Register(app);
            UnityEngine_AI_NavMeshAgent_Binding.Register(app);
            ETModel_CharacterComponent_Binding.Register(app);
            ETModel_GamerComponent_Binding.Register(app);
            ETModel_User_Binding.Register(app);
            ETModel_GamerAnimatorComponent_Binding.Register(app);
            ETModel_TimerComponent_Binding.Register(app);
            ETModel_LandlordsGamerPanelComponent_Binding.Register(app);
            System_Collections_Generic_IEnumerator_1_Google_Protobuf_Adapt_IMessage_Binding_Adaptor_Binding.Register(app);
            ETModel_HandCardsComponent_Binding.Register(app);
            ETModel_CardHelper_Binding.Register(app);
            UnityEngine_UI_Image_Binding.Register(app);
            ReferenceCollector_Binding.Register(app);
            ETModel_TimeHelper_Binding.Register(app);
            ETModel_GamerTurnComponent_Binding.Register(app);
            System_Collections_Generic_List_1_Gamer_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_Int32_Gamer_Binding_ValueCollection_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_Int32_Gamer_Binding_ValueCollection_Binding_Enumerator_Binding.Register(app);
            ETModel_AsyncETTaskMethodBuilder_Binding.Register(app);
            ETModel_GamerPathComponent_Binding.Register(app);
            System_Threading_CancellationTokenSource_Binding.Register(app);
            System_Collections_Generic_List_1_Vector3_Binding_t.Register(app);
            ETModel_GamerMoveComponent_Binding.Register(app);
            ...
            System_Collections_Generic_List_1_Card_Binding_Enumerator_Binding.Register(app);
