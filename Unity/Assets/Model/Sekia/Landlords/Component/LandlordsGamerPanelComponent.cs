...
namespace ETModel
{
    ...
    public class LandlordsGamerPanelComponent : Component
    {
        ...
        {
            G2C_GetUserInfo_Back g2C_GetUserInfo_Ack = (G2C_GetUserInfo_Back)await SessionComponent.Instance.Session.Call(new C2G_GetUserInfo_Req() { UserID = this.GetParent<Gamer>().UserID });
